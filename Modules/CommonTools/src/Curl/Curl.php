...
namespace Modules\CommonTools\Src\Curl;
...
class Curl
{
    ...
    private $jsonDecoder = '\Modules\CommonTools\Src\Curl\Decoder::decodeJson';
    private $jsonDecoderArgs = array();
    private $jsonPattern = '/^(?:application|text)\/(?:[a-z]+(?:[\.-][0-9a-z]+){0,}[\+\.]|x-)?json(?:-[a-z]+)?/i';
    private $xmlDecoder = '\Modules\CommonTools\Src\Curl\Decoder::decodeXml';
    ...
    {
        $this->jsonDecoder = '\Modules\CommonTools\Src\Curl\Decoder::decodeJson';
    ...
    {
        $this->xmlDecoder = '\Modules\CommonTools\Src\Curl\Decoder::decodeXml';
    }
