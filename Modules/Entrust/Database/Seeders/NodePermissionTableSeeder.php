...
class NodePermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $nodePmServ->addUriPermissionToNode('/api/1.0/article/like', $memberPermissionName);
        $nodePmServ->addUriPermissionToNode('/api/1.0/article/unlike', $memberPermissionName);
    }
}
